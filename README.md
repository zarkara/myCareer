...
See [docs/unit-economics.md](docs/unit-economics.md) for what hosted inference costs,
[docs/recruiter.md](docs/recruiter.md) for the projection and matching design,
